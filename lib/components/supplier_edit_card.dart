...
class SupplierEditCard extends StatefulWidget {
  final SupplierDTO supplierDTO;
  final void Function(SupplierDTO) callBack;
  const SupplierEditCard({Key? key, required this.supplierDTO, required this.callBack}) : super(key: key);

  @override
  State<SupplierEditCard> createState() => _SupplierEditCardState();
}

class _SupplierEditCardState extends State<SupplierEditCard> {
  String imgURL = "";
  ...
  @override
  void didUpdateWidget(SupplierEditCard oldWidget) {
